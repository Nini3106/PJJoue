...
const NOM_CACHE = 'pjjoue-application-ba2468d7fe24';
const RESSOURCES_ESSENTIELLES = [
  './',
  './index.html',
  './ressources/styles/atlas-systeme.css?v=ba2468d7fe24',
  './manifest.webmanifest',
  './donnees/donnees-pjj.js?v=ba2468d7fe24',
  './ressources/moteur-jeu.js?v=ba2468d7fe24',
  './ressources/navigation-locale.js?v=ba2468d7fe24',
  './ressources/consentement-analytics.js?v=ba2468d7fe24',
  './ressources/videos-guides.js?v=ba2468d7fe24',
  './ressources/styles/pjjoue-principal.css?v=ba2468d7fe24',
  './ressources/styles/pjjoue-static.css?v=ba2468d7fe24',
  './ressources/styles/95-consentement.css?v=ba2468d7fe24',
  './guides/index.html',
  './guides/style-de-la-page.css?v=ba2468d7fe24',
  './rrse-mineur/index.html',
  './rrse-mineur/style-de-la-page.css?v=ba2468d7fe24',
  './peines-mineurs-cjpm/index.html',
  './peines-mineurs-cjpm/style-de-la-page.css?v=ba2468d7fe24',
  './cjpm-enquete-sanction/index.html',
  './cjpm-enquete-sanction/style-de-la-page.css?v=ba2468d7fe24',
  './cjpm-information-judiciaire/index.html',
  './cjpm-information-judiciaire/style-de-la-page.css?v=ba2468d7fe24',
  './cjpm-jugement-sanction-educative/index.html',
  './cjpm-jugement-sanction-educative/style-de-la-page.css?v=ba2468d7fe24',
  './cjpm-matiere-criminelle-peines/index.html',
  './cjpm-matiere-criminelle-peines/style-de-la-page.css?v=ba2468d7fe24',
  './cjpm-application-execution/index.html',
  './cjpm-application-execution/style-de-la-page.css?v=ba2468d7fe24',
  './decouvrir-la-pjj/index.html',
  './decouvrir-la-pjj/style-de-la-page.css?v=ba2468d7fe24',
  './organisation-pjj/index.html',
  './organisation-pjj/style-de-la-page.css?v=ba2468d7fe24',
  './metiers-pjj/index.html',
  './metiers-pjj/style-de-la-page.css?v=ba2468d7fe24',
  './structures-pjj/index.html',
  './structures-pjj/style-de-la-page.css?v=ba2468d7fe24',
  './mesures-educatives-pjj/index.html',
  './mesures-educatives-pjj/style-de-la-page.css?v=ba2468d7fe24',
  './sigles-cjpm/index.html',
  './sigles-cjpm/style-de-la-page.css?v=ba2468d7fe24',
  './sigles-pjj/index.html',
  './sigles-pjj/style-de-la-page.css?v=ba2468d7fe24',
  './quiz-pjj/index.html',
  './quiz-pjj/style-de-la-page.css?v=ba2468d7fe24',
