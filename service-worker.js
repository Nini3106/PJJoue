...
const NOM_CACHE = 'pjjoue-application-6d2f3fbfbc21';
const RESSOURCES_ESSENTIELLES = [
  './',
  './index.html',
  './ressources/styles/atlas-systeme.css?v=6d2f3fbfbc21',
  './manifest.webmanifest',
  './donnees/donnees-pjj.js?v=6d2f3fbfbc21',
  './ressources/moteur-jeu.js?v=6d2f3fbfbc21',
  './ressources/navigation-locale.js?v=6d2f3fbfbc21',
  './ressources/consentement-analytics.js?v=6d2f3fbfbc21',
  './ressources/videos-guides.js?v=6d2f3fbfbc21',
  './ressources/styles/pjjoue-principal.css?v=6d2f3fbfbc21',
  './ressources/styles/pjjoue-static.css?v=6d2f3fbfbc21',
  './ressources/styles/95-consentement.css?v=6d2f3fbfbc21',
  './guides/index.html',
  './guides/style-de-la-page.css?v=6d2f3fbfbc21',
  './rrse-mineur/index.html',
  './rrse-mineur/style-de-la-page.css?v=6d2f3fbfbc21',
  './peines-mineurs-cjpm/index.html',
  './peines-mineurs-cjpm/style-de-la-page.css?v=6d2f3fbfbc21',
  './cjpm-enquete-sanction/index.html',
  './cjpm-enquete-sanction/style-de-la-page.css?v=6d2f3fbfbc21',
  './cjpm-information-judiciaire/index.html',
  './cjpm-information-judiciaire/style-de-la-page.css?v=6d2f3fbfbc21',
  './cjpm-jugement-sanction-educative/index.html',
  './cjpm-jugement-sanction-educative/style-de-la-page.css?v=6d2f3fbfbc21',
  './cjpm-matiere-criminelle-peines/index.html',
  './cjpm-matiere-criminelle-peines/style-de-la-page.css?v=6d2f3fbfbc21',
  './cjpm-application-execution/index.html',
  './cjpm-application-execution/style-de-la-page.css?v=6d2f3fbfbc21',
  './decouvrir-la-pjj/index.html',
  './decouvrir-la-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
  './organisation-pjj/index.html',
  './organisation-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
  './metiers-pjj/index.html',
  './metiers-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
  './structures-pjj/index.html',
  './structures-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
  './mesures-educatives-pjj/index.html',
  './mesures-educatives-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
  './sigles-cjpm/index.html',
  './sigles-cjpm/style-de-la-page.css?v=6d2f3fbfbc21',
  './sigles-pjj/index.html',
  './sigles-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
  './quiz-pjj/index.html',
  './quiz-pjj/style-de-la-page.css?v=6d2f3fbfbc21',
