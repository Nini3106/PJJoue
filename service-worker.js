...
const NOM_CACHE = 'pjjoue-application-a64413728565';
const RESSOURCES_ESSENTIELLES = [
  './',
  './index.html',
  './manifest.webmanifest',
  './donnees/donnees-pjj.js?v=a64413728565',
  './ressources/moteur-jeu.js?v=a64413728565',
  './ressources/navigation-locale.js?v=a64413728565',
  './ressources/consentement-analytics.js?v=a64413728565',
  './ressources/videos-guides.js?v=a64413728565',
  './ressources/styles/pjjoue-principal.css?v=a64413728565',
  './ressources/styles/pjjoue-static.css?v=a64413728565',
  './ressources/styles/95-consentement.css?v=a64413728565',
  './guides/index.html',
  './guides/style-de-la-page.css?v=a64413728565',
  './cjpm-enquete-sanction/index.html',
  './cjpm-enquete-sanction/style-de-la-page.css?v=a64413728565',
  './cjpm-information-judiciaire/index.html',
  './cjpm-information-judiciaire/style-de-la-page.css?v=a64413728565',
  './cjpm-jugement-sanction-educative/index.html',
  './cjpm-jugement-sanction-educative/style-de-la-page.css?v=a64413728565',
  './cjpm-matiere-criminelle-peines/index.html',
  './cjpm-matiere-criminelle-peines/style-de-la-page.css?v=a64413728565',
  './cjpm-application-execution/index.html',
  './cjpm-application-execution/style-de-la-page.css?v=a64413728565',
  './decouvrir-la-pjj/index.html',
  './decouvrir-la-pjj/style-de-la-page.css?v=a64413728565',
  './organisation-pjj/index.html',
  './organisation-pjj/style-de-la-page.css?v=a64413728565',
  './metiers-pjj/index.html',
  './metiers-pjj/style-de-la-page.css?v=a64413728565',
  './structures-pjj/index.html',
  './structures-pjj/style-de-la-page.css?v=a64413728565',
  './mesures-educatives-pjj/index.html',
  './mesures-educatives-pjj/style-de-la-page.css?v=a64413728565',
  './sigles-cjpm/index.html',
  './sigles-cjpm/style-de-la-page.css?v=a64413728565',
  './sigles-pjj/index.html',
  './sigles-pjj/style-de-la-page.css?v=a64413728565',
  './quiz-pjj/index.html',
  './quiz-pjj/style-de-la-page.css?v=a64413728565',
