...
const NOM_CACHE = 'pjjoue-application-dfeb7a555341';
const RESSOURCES_ESSENTIELLES = [
  './',
  './index.html',
  './manifest.webmanifest',
  './donnees/donnees-pjj.js?v=dfeb7a555341',
  './ressources/moteur-jeu.js?v=dfeb7a555341',
  './ressources/navigation-locale.js?v=dfeb7a555341',
  './ressources/consentement-analytics.js?v=dfeb7a555341',
  './ressources/videos-guides.js?v=dfeb7a555341',
  './ressources/styles/pjjoue-principal.css?v=dfeb7a555341',
  './ressources/styles/pjjoue-static.css?v=dfeb7a555341',
  './ressources/styles/95-consentement.css?v=dfeb7a555341',
  './guides/index.html',
  './guides/style-de-la-page.css?v=dfeb7a555341',
  './cjpm-enquete-sanction/index.html',
  './cjpm-enquete-sanction/style-de-la-page.css?v=dfeb7a555341',
  './cjpm-information-judiciaire/index.html',
  './cjpm-information-judiciaire/style-de-la-page.css?v=dfeb7a555341',
  './cjpm-jugement-sanction-educative/index.html',
  './cjpm-jugement-sanction-educative/style-de-la-page.css?v=dfeb7a555341',
  './cjpm-matiere-criminelle-peines/index.html',
  './cjpm-matiere-criminelle-peines/style-de-la-page.css?v=dfeb7a555341',
  './cjpm-application-execution/index.html',
  './cjpm-application-execution/style-de-la-page.css?v=dfeb7a555341',
  './decouvrir-la-pjj/index.html',
  './decouvrir-la-pjj/style-de-la-page.css?v=dfeb7a555341',
  './organisation-pjj/index.html',
  './organisation-pjj/style-de-la-page.css?v=dfeb7a555341',
  './metiers-pjj/index.html',
  './metiers-pjj/style-de-la-page.css?v=dfeb7a555341',
  './structures-pjj/index.html',
  './structures-pjj/style-de-la-page.css?v=dfeb7a555341',
  './mesures-educatives-pjj/index.html',
  './mesures-educatives-pjj/style-de-la-page.css?v=dfeb7a555341',
  './sigles-cjpm/index.html',
  './sigles-cjpm/style-de-la-page.css?v=dfeb7a555341',
  './sigles-pjj/index.html',
  './sigles-pjj/style-de-la-page.css?v=dfeb7a555341',
  './quiz-pjj/index.html',
  './quiz-pjj/style-de-la-page.css?v=dfeb7a555341',
