...
const NOM_CACHE = 'pjjoue-application-d6332a80dbc3';
const RESSOURCES_ESSENTIELLES = [
  './',
  './index.html',
  './ressources/styles/atlas-systeme.css?v=d6332a80dbc3',
  './manifest.webmanifest',
  './donnees/donnees-pjj.js?v=d6332a80dbc3',
  './ressources/moteur-jeu.js?v=d6332a80dbc3',
  './ressources/navigation-locale.js?v=d6332a80dbc3',
  './ressources/consentement-analytics.js?v=d6332a80dbc3',
  './ressources/videos-guides.js?v=d6332a80dbc3',
  './ressources/styles/pjjoue-principal.css?v=d6332a80dbc3',
  './ressources/styles/pjjoue-static.css?v=d6332a80dbc3',
  './ressources/styles/95-consentement.css?v=d6332a80dbc3',
  './guides/index.html',
  './guides/style-de-la-page.css?v=d6332a80dbc3',
  './rrse-mineur/index.html',
  './rrse-mineur/style-de-la-page.css?v=d6332a80dbc3',
  './peines-mineurs-cjpm/index.html',
  './peines-mineurs-cjpm/style-de-la-page.css?v=d6332a80dbc3',
  './cjpm-enquete-sanction/index.html',
  './cjpm-enquete-sanction/style-de-la-page.css?v=d6332a80dbc3',
  './cjpm-information-judiciaire/index.html',
  './cjpm-information-judiciaire/style-de-la-page.css?v=d6332a80dbc3',
  './cjpm-jugement-sanction-educative/index.html',
  './cjpm-jugement-sanction-educative/style-de-la-page.css?v=d6332a80dbc3',
  './cjpm-matiere-criminelle-peines/index.html',
  './cjpm-matiere-criminelle-peines/style-de-la-page.css?v=d6332a80dbc3',
  './cjpm-application-execution/index.html',
  './cjpm-application-execution/style-de-la-page.css?v=d6332a80dbc3',
  './decouvrir-la-pjj/index.html',
  './decouvrir-la-pjj/style-de-la-page.css?v=d6332a80dbc3',
  './organisation-pjj/index.html',
  './organisation-pjj/style-de-la-page.css?v=d6332a80dbc3',
  './metiers-pjj/index.html',
  './metiers-pjj/style-de-la-page.css?v=d6332a80dbc3',
  './structures-pjj/index.html',
  './structures-pjj/style-de-la-page.css?v=d6332a80dbc3',
  './mesures-educatives-pjj/index.html',
  './mesures-educatives-pjj/style-de-la-page.css?v=d6332a80dbc3',
  './sigles-cjpm/index.html',
  './sigles-cjpm/style-de-la-page.css?v=d6332a80dbc3',
  './sigles-pjj/index.html',
  './sigles-pjj/style-de-la-page.css?v=d6332a80dbc3',
  './quiz-pjj/index.html',
  './quiz-pjj/style-de-la-page.css?v=d6332a80dbc3',
