Warning: truncated output (original token count: 117984)
Total output lines: 8638
...
function construireChoisirPuisOrdonner(question, activite) {
    ...
    const selectionnes = etat.brouillonActivite.ordre ||…17984 tokens truncated…arateur';
