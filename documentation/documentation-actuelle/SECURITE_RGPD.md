...
`ressources/analytics-pjjoue.js` bloque les événements métier tant que le consentement n’est pas accordé. Pour les questions, les événements transmettent uniquement l’identifiant permanent de type `Qxxx` ainsi que les repères techniques et résultats utiles au suivi. L’énoncé de la question, la réponse libre saisie par l’utilisateur, le contenu d’une sauvegarde, un nom, une adresse e-mail, un numéro de téléphone ou une autre donnée d’identité directe ne sont pas transmis.
