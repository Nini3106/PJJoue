...
class HarmonisationInterfaceTests(unittest.TestCase):
    ...
    def test_libelles_missions_et_phrase_pedagogique_sont_valides(self) -> None:
        ...
        self.assertIn("['cjpm','pjj','tous']", sigles_js)
        self.assertIn("'Tous les sigles'", sigles_js)
    ...
    def test_question_parametres_et_entrainement_respectent_les_nouvelles_regles(self) -> None:
        ...
        self.assertIn("const pasCurseur = 1;", entrainement_js)
        self.assertIn('id="curseurNombreQuestions" type="range" min="1" max="660" step="1"', entrainement_html)
    ...
    def test_identite_couleur_parcours_et_etapes_est_une_regle_manifeste(self) -> None:
        ...
        self.assertIn("obtenirIdentiteParcours(cible.theme)", revision_js)
        self.assertIn("--repere-accent:${couleur};--repere-texte:${couleurTexte}", revision_js)
        self.assertIn("couleur:identite.couleurTexte || identite.couleur", revision_js)
        self.assertIn("--filtre-accent:${option.couleur}", revision_js)
