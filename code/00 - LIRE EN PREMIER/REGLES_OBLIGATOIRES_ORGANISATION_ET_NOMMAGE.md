...
- **Maîtrise sans joker — étoile filante obligatoire** : dans la page Parcours, toute étape maîtrisée sans joker reçoit une étoile **avec une traînée graphique visible** (jamais une étoile seule). La carte du parcours correspondant affiche le même symbole avec le nombre de jalons maîtrisés : étapes autonomes + évaluation finale réussie. Le compteur va donc de 1 à 12 et affiche 12 lorsque les 11 étapes et l’évaluation sont maîtrisées.
