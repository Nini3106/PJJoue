...
def main() -> int:
    ...
    for chemin in pages:
        ...
        # Les deux entrées de l’application regroupent plusieurs écrans dynamiques, chacun avec son propre h1.
