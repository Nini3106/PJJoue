...
La page **Réviser** donne accès à **Mission Sigles**, un mini-jeu consacré à 96 sigles : 51 sigles CJPM répartis en cinq étapes et 45 sigles PJJ répartis en quatre étapes. Le choix CJPM est proposé par défaut ; PJJ et Tous restent accessibles dans le même mini-jeu. Le module comprend un entraînement configurable, un Défi du hasard, la révision des erreurs, une progression dédiée et une évaluation de 30 activités par domaine, avec un seuil de réussite de 90 %. Les 72 sigles historiques et les acquis sont conservés.

La progression pédagogique reprend la logique des parcours principaux : **un sigle n’est jamais demandé seul avant d’avoir été introduit dans une activité précédente avec son développement complet**. Les **96 questions d’introduction sont contextualisées individuellement** : chacune possède un sujet explicite et trois distracteurs rédigés à la main ; les formulations génériques sans sujet sont interdites par les tests. Il n’existe pas d’écran qui donne les réponses avant de jouer. L’entraînement permet de choisir le domaine CJPM, le domaine PJJ, une étape ou tout Mission Sigles, 10 / 20 / 30 / Tous, un ordre par étapes ou mélangé, avec ou sans chrono et avec ou sans jokers. Le Défi du hasard utilise le même dé animé que PJJoue, tire de 1 à 6 questions puis attend le clic de l’utilisateur pour démarrer ; les jokers y sont autorisés.
...
Dans les parcours, Mission Sigles et Mission Mesures, toute réponse correcte sans joker est validée en autonomie, y compris après avoir rejoué la question. Après une reprise, elle reste signalée « à consolider » sans pénaliser le score, la maîtrise ni la validation de la session. Les réponses incorrectes, les questions passées et les réponses avec joker rejoignent aussi cette liste. Une réussite sans joker dès la première tentative d’une nouvelle session retire la question de cette liste, quel que soit le mode de jeu. Les introductions des mini-jeux restent des découvertes ; la maîtrise d’une notion se valide dans son rappel. Une révision générale ou un entraînement peut aussi consolider une question déjà travaillée dans son étape, sans démarrer une étape jamais visitée.
...
Le marqueur `reprisesSansJokerValidees` accompagne la reconnaissance des anciennes réussites après reprise : les validations sans joker déjà enregistrées deviennent des acquis autonomes, sans gain rétroactif d’XP ni suppression de l’historique. Cette migration unique privilégie la validation connue, car les anciennes données ne permettent pas de dater chaque tentative. Les nouvelles questions à consolider restent actives jusqu’à une réussite directe sans joker. Le champ `motifRevision` distingue reprise validée, joker, passage et réponse incorrecte ; les compteurs de révision ne sont pas présentés comme des nombres d’erreurs. Les sessions interrompues reclassent également leurs réponses explicitement enregistrées sans joker après reprise.
